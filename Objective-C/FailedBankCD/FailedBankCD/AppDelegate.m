...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    NSError  *err;
    NSString *dataPath = [[NSBundle mainBundle] pathForResource:@"FailedBankCD" ofType:@"sqlite"];
    
    NSArray  *Banks    = [NSJSONSerialization JSONObjectWithData:[NSData dataWithContentsOfFile:dataPath]
                                                                  options:kNilOptions
                                                                  error:&err];
    DLog(@"Imported Banks: %@", Banks);
    ...
    [Banks enumerateObjectsUsingBlock:^(id  _Nonnull obj, NSUInteger idx, BOOL * _Nonnull stop)
    {
        ...
        {
            DLog(@"Opps, couldn't save: %@", [error localizedDescription]);
        }
    }];
    
    // Test listing all FailledBankInfos from the store
...
- (NSURL *)applicationDocumentsDirectory {
    // The directory the application uses to store the Core Data store file. This code uses a directory named "com.sijiadavis.FailedBankCD" in the application's documents directory.
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator {
    ...
    {
        NSLog(@"path : %@", [NSBundle mainBundle]);
        
        
        NSLog(@"file url : %@", [[NSBundle mainBundle]
                                 pathForResource:@"FailedBankCD" ofType:@"sqlite"]);
        ...
        {
            DLog(@"Opps, could not copy preloaded data");
        }
    }
