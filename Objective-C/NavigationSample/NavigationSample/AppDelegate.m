...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    // Set the instance of FirstViewController as root view controller
    // when creating an instance of UINavigationController.
    self.navController = [[UINavigationController alloc] initWithRootViewController:cont];
    
    // set navController as the root controller for main window.
